...
class FBPFanCurveOp : public OpKernel
{
protected:
...
public:
    explicit FBPFanCurveOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER( Name( "FBPFanCurve" ).Device( DEVICE_GPU ), FBPFanCurveOp );
